...
for f in ${base_path}/*/*_analysis/interfaces.csv
do
  t=$(dirname $f)
  tt=$(dirname $t)
  name=$(basename $tt)
...
cat ${base_path}/*/*_analysis/interfaces.csv.foldname.csv >> ${base_path}/${base_path_name}.interfaces.csv

echo "generating ${base_path_name}.summary.csv..."
for f in ${base_path}/*/*_analysis/summary.csv
do
  t=$(dirname $f)
  tt=$(dirname $t)
  name=$(basename $tt)
...
cat ${base_path}/*/*_analysis/summary.csv.foldname.csv >> ${base_path}/${base_path_name}.summary.csv

echo "generating ${base_path_name}.contacts.csv..."
for f in ${base_path}/*/*_analysis/contacts.csv
do
  t=$(dirname $f)
  tt=$(dirname $t)
  name=$(basename $tt)
...
cat ${base_path}/*/*_analysis/contacts.csv.foldname.csv >> ${base_path}/${base_path_name}.contacts.csv
